...
import { User, FileCheck, MessageSquare } from "lucide-react";
...
export const TestDetailsDialog = ({ 
  ...
  const handleOpenChat = () => {
    onOpenChange(false); // Close test details dialog
    setSelectedDoctor(doctorInfo); // Set the selected doctor to the one from this test
